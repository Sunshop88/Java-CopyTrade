...
import net.maku.followcom.service.PlatformServicePt;
...
@Slf4j
@DS("slave2")
public class PlatformServiceImplPt extends BaseServiceImpl<PlatformDao, PlatformEntity> implements PlatformServicePt {
