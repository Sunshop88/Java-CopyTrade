...
import net.maku.followcom.service.ServerServicePt;
...
@Slf4j
@DS("slave2")
public class ServerServiceImplPt extends BaseServiceImpl<ServerDao, ServerEntity> implements ServerServicePt {
