...
import net.maku.followcom.service.ClientServicePt;
...
@Slf4j
@DS("slave2")
public class ClientServiceImplPt extends BaseServiceImpl<ClientDao, ClientEntity> implements ClientServicePt {
