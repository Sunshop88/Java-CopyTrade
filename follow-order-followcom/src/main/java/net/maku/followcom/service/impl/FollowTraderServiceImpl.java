...
//            if (redissonLockUtil.tryLockForShortTime("orderCloseMaster"+FollowConstant.LOCAL_HOST+quoteClient.Host+quoteClient.AccountName(),100,10, TimeUnit.SECONDS)) {
                try {
                    ...
                    bid = ObjectUtil.isNotEmpty(quoteEventArgs)&&ObjectUtil.isNotEmpty(quoteEventArgs.Bid) ? quoteEventArgs.Bid : 0;
                    ask = ObjectUtil.isNotEmpty(quoteEventArgs)&&ObjectUtil.isNotEmpty(quoteEventArgs.Ask) ? quoteEventArgs.Ask : 0;
