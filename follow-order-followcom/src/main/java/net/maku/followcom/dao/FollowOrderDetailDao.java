...
public interface FollowOrderDetailDao extends BaseDao<FollowOrderDetailEntity> {
    ...
    @Insert({
            ...
            "#{OrderDetail.send_no},",
            "#{OrderDetail.trader_id},",
            "#{OrderDetail.account},",
            "#{OrderDetail.request_open_time},",
            "#{OrderDetail.request_open_price},",
            "#{OrderDetail.open_time},",
            "#{OrderDetail.response_open_time},",
            "#{OrderDetail.open_price},",
            "#{OrderDetail.open_price_slip},",
            "#{OrderDetail.open_time_difference},",
            "#{OrderDetail.request_close_time},",
            "#{OrderDetail.request_close_price},",
            "#{OrderDetail.close_time},",
            "#{OrderDetail.response_close_time},",
            "#{OrderDetail.close_price},",
            "#{OrderDetail.close_price_slip},",
            "#{OrderDetail.close_time_difference},",
            "#{OrderDetail.size},",
            "#{OrderDetail.tp},",
            "#{OrderDetail.sl},",
            ...
            "#{OrderDetail.placed_type},",
            "#{OrderDetail.broker_name},",
            "#{OrderDetail.server},",
            "#{OrderDetail.ip_addr},",
            "#{OrderDetail.server_name},",
            "#{OrderDetail.close_id},",
            "#{OrderDetail.close_status},",
            "#{OrderDetail.magical},",
            "#{OrderDetail.source_user},",
            "#{OrderDetail.rate_margin},",
            "#{OrderDetail.server_host},",
            "#{OrderDetail.close_ip_addr},",
            "#{OrderDetail.close_server_name},",
            "#{OrderDetail.close_server_host},",
            "#{OrderDetail.is_external}",
            ")",
            "</foreach>",
