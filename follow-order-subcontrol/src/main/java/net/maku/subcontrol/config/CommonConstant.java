...
public interface CommonConstant {
    ...
    */
    ...
    public final static String X_FORWARDED_FOR = "X_FORWARDED_FOR";
    ...
    String WECHAT_OFFIACCOUNT_ACCESS_TOKEN = "wechat_offiaccount_access_token";

    /**
     * 记录修改定时器是否需要执行
     */
    String UpdatePasswordKey = "update_password_key";

    /**
     * 记录提现时需扣除的备用金金额和佣金金额
     */
    String WITHDRAWKEY = "withdraw:amount";

    /**
     * 记录交易账户最大连续盈利、最大连续亏损、最大连续盈利单数、最大连续亏损单数
     */
    String STATEMENT = "statement:tradeId";
