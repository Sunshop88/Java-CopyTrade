...
import net.maku.subcontrol.task.UpdateLeaderTraderInfoTask;
...
public class LeaderApiTrader extends AbstractApiTrader {
    ...
    private Boolean startTrade(ExecutorService executorService, List<String> subscriptions) {
        super.updateTradeInfoFuture = this.scheduledExecutorService.scheduleWithFixedDelay(new UpdateLeaderTraderInfoTask(this), 6, 5, TimeUnit.SECONDS);
