...
import net.maku.subcontrol.task.UpdateCopier4TraderInfoTask;
...
public class CopierApiTrader extends AbstractApiTrader {
    ...
    private Boolean startTrade(ExecutorService executorService, List<String> topics) {
        super.updateTradeInfoFuture = this.scheduledExecutorService.scheduleWithFixedDelay(new UpdateCopier4TraderInfoTask(CopierApiTrader.this), 2, 5, TimeUnit.SECONDS);
