...
public class AbstractOperation {
    ...
    protected ThreeStrategyThreadPoolExecutor threeStrategyThreadPoolExecutor;
    ...
    public AbstractOperation(FollowTraderEntity trader) {
        ...
        this.threeStrategyThreadPoolExecutor = SpringContextUtils.getBean("analysisExecutorService", ThreeStrategyThreadPoolExecutor.class);
