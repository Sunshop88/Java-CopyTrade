...
public class CopierKafkaMessageCallbackImpl extends AbstractKafkaMessageCallback implements KafkaMessageCallback<String, Object> {
    ...
    public CopierKafkaMessageCallbackImpl(CopierApiTrader copierApiTrader) {
        ...
        operationStrategy.put(AcEnum.NEW, new OrderSendSlave(copierApiTrader));
        operationStrategy.put(AcEnum.MODIFIED, new OrderModifySlave(copierApiTrader));
        operationStrategy.put(AcEnum.DELETED, new OrderDeleteSlave(copierApiTrader));
        operationStrategy.put(AcEnum.CLOSED, new OrderCloseSlave(copierApiTrader));
